...
def _get_open_connections(client: AcmeAISDK | AsyncAcmeAISDK) -> int:
...
class TestAcmeAisdk:
    client = AcmeAISDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "acme_ai_sdk/_legacy_response.py",
                        "acme_ai_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "acme_ai_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(AcmeAisdkError):
            with update_env(**{"ACME_AI_SDK_BEARER_TOKEN": Omit()}):
                client2 = AcmeAISDK(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: AcmeAISDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ACME_AI_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AcmeAISDK(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: AcmeAISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AcmeAISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AcmeAISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AcmeAISDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = AcmeAISDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/files/").mock(side_effect=retry_handler)

        response = client.files.with_raw_response.file_create(file=b"raw file contents")
    ...
    def test_omit_retry_count_header(
        self, client: AcmeAISDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncAcmeAisdk:
    client = AsyncAcmeAISDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(AcmeAisdkError):
            with update_env(**{"ACME_AI_SDK_BEARER_TOKEN": Omit()}):
                client2 = AsyncAcmeAISDK(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAcmeAISDK) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ACME_AI_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncAcmeAISDK(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncAcmeAISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAcmeAISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAcmeAISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAcmeAISDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncAcmeAISDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.files.with_raw_response.file_create(file=b"raw file contents")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncAcmeAISDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.files.with_raw_response.file_create(
            file=b"raw file contents", extra_headers={"x-stainless-retry-count": Omit()}
        )
